                        ...
                        <div class="form-group">
                           <div class="col-md-12">
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-10">
                                    <input required disabled type="text" maxlength="30" class="form-control" id="nombre_contacto">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           <div class="col-md-12">
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-10">
                                    <input required disabled type="text" maxlength="30" class="form-control" id="apellido_contacto">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           <div class="col-md-12">
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-10">
                                    <input required disabled type="text" maxlength="30" class="form-control" id="cargo_contacto">
                                 </div>
                              </div>
                           </div>
                        </div> 
                        ...
                        <div class="form-group">
                           <div class="col-md-12">
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-5">
                                    <input disabled type="text" maxlength="12" class="form-control" id="telefono" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                                 </div>
                              </div>
                           </div>
                        </div>
