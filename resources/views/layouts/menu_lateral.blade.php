   ...
   <div class="navbar-menu-wrapper d-flex align-items-center">
      <ul class="navbar-nav ml-auto">
         <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
            ...
            <img class="img-xs rounded-circle" src="{{ asset('/assets/images/faces/') }}<?='/'.session('img_perfil');?>" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
               <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="{{ asset('/assets/images/faces/') }}<?='/'.session('img_perfil');?>" alt="Profile image">
...
<nav class="sidebar sidebar-offcanvas" id="sidebar">    
   <ul class="nav">
      <li class="nav-item nav-profile">
         <a href="./admin_usuarios" class="nav-link">
      ...
      <li class="nav-item">
         ...
         <div class="collapse" id="menu_documentos">
            <ul class="nav flex-column sub-menu">
               ...
               <li class="nav-item">
                  <a class="nav-link" href="./admin_grapes">Templates Grapes</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="./admin_wysiwyg">Templates WYSIWYG</a>
               </li>
            </ul>
         </div>
      </li>
